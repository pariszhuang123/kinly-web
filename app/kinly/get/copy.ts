...
const COPY_OVERRIDES: Record<string, Partial<GetCopy>> = {
  ar: {
    title: "احصل على كينلي",
    inviteDetected: "تم اكتشاف رمز الدعوة:",
    homeDetected: "تم اكتشاف المنزل:",
    lead: "سنراسلك عندما يفتح كينلي في منطقتك — بدون رسائل مزعجة.",
    emailLabel: "البريد الإلكتروني",
    emailPlaceholder: "انت@مثال.com",
    emailError: "أدخل بريداً إلكترونياً صالحاً.",
    countryLabel: "الدولة",
    countryPlaceholder: "رمز الدولة (مثال: SA)",
    countryError: "استخدم رمزاً من حرفين.",
    detectedCountryPrefix: "الدولة المكتشفة:",
    searchLabel: "البحث عن الدول",
    searchPlaceholder: "اكتب للتصفية",
    searchAriaLabel: "الدول",
    submitCta: "طلب الوصول",
    backCta: "العودة للرئيسية",
    successHeading: "شكراً — استلمنا طلبك.",
    successBody: "سنخبرك عندما يكون كينلي جاهزاً في منطقتك.",
    cooldownMessage: "محاولات كثيرة — انتظر 30 ثانية وحاول مرة أخرى.",
    errorGeneric: "حدث خطأ. حاول مرة أخرى.",
    errorRateLimit: "محاولات كثيرة — انتظر 30 ثانية وحاول مرة أخرى.",
    errorEmailInvalid: "أدخل بريداً إلكترونياً صالحاً.",
    errorCountryInvalid: "استخدم رمز دولة من حرفين.",
    errorLocaleInvalid: "فشل اكتشاف اللغة. أعد تحميل الصفحة وحاول مرة أخرى.",
    errorConfigMissing: "النموذج غير جاهز بعد. حاول لاحقاً.",
    redirectTitle: "أنت في القائمة.",
    redirectBody: "حفظنا مكانك وسننقلك لقصة كينلي لترى ما يمكن توقعه.",
    redirectCountdown: "إعادة التوجيه خلال {seconds} ثانية...",
    redirectGoNow: "اذهب الآن",
    redirectStay: "ابق هنا",
  },
  es: {
