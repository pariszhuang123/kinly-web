...
export const fitCheckCopy = {
  owner: {
    ...
    subtitle:
      "Quick questions to help you screen for everyday fit before a viewing.",
    intro:
      "Answer four quick questions, add your location, and generate a share link for shortlisted applicants.",
    ...
    locationTitle: "Where is the room?",
    locationBody: "One last step before we generate your applicant link.",
    countryLabel: "Country",
    countryHint: "Choose the country for this room.",
    cityLabel: "City",
    ...
    questionsSubtitle: "Start with the questions most likely to surface deal-breakers.",
    ...
    questionsPreviewOpen: "Show interview questions",
